...
public class ImageTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BufferedImage originalImage = ImageIO.read(new File("C:\\image\\image-human-qrcode.jpg"));
	...
	public static void ConvertBase64() throws IOException{
		...
		ImageIO.write(resizeImageHintPng, "png", new File("c:\\image\\daniel.jpg"));
