...
@Stateless
public class ParametroRepositorio extends RepositorioPadrao<Parametro> {

	@Inject
	private EntityManager entityManager;

	public ParametroRepositorio() {
	...
	public List<Parametro> buscaComFiltro(int pagina, int resultados, Map<String, String> queryParams) {
